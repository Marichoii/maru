export const GLOSSARY = [
  ...
  { id: "noun", term: "Substantivo", aliases: ["substantivo", "nominal"], definition: "Palavra que dá nome a uma pessoa, lugar, coisa ou ideia.", example: "本 (hon, livro) e 学生 (gakusei, estudante) são substantivos." },
  ...
  { id: "adjective", term: "Adjetivo", aliases: ["adjetivo"], definition: "Palavra usada para descrever uma característica.", example: "おいしい (oishii) significa gostoso. Em おいしいパン, descreve o pão." },
