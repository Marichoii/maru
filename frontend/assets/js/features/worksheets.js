...
export function renderWorksheets(ctx) {
  ...
  function draw() {
    ...
    if (kind === "characters") {
      ...
      sheets = chunks(items,5).map(page => header(script === "kanji" ? "Primeiros kanji" : script === "hiragana" ? "Hiragana" : "Katakana") +
