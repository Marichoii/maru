...
export const audioButton = (text, label = "Ouvir pronúncia") => `<button class="icon-button audio-button" data-speak="${esc(text)}" aria-label="${esc(label)}" title="${esc(label)}">${icon("volume")}</button>`;
